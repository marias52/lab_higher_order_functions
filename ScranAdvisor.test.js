...
describe('ScranAdvisor', () => {
    ...
    test('can count the number of restaurants', () => {
        const expected = 23;
        const actual = scranAdvisor.canCountResturants();
    ...
    test('can find the name of all restaurants', () => {
        const expected = [
          ...
          const actual = scranAdvisor.allRestaurantName()
          expect(actual).toEqual(expected);
    })
    ...
    test('can find all restaurants from Glasgow', () => {
        const expected = [
          ...
          const actual = scranAdvisor.resturantsInGlasgow();
          expect(actual).toEqual(expected);
    })
    ...
    test.skip('can find restaurant with substring', () => {
      const expected = ''
      const actual = scranAdvisor.findResturantWithSubstring();
       expect(actual).toEqual(expected);
    })
